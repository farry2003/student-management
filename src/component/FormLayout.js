                ...
                <form onSubmit={(e) => props.updateData(e)}>
                    <div className="form-group">
                        ...
                        <div className="form-body">
                            ...
                            {/* row gender */}
                            <div className="form-group row">
                                <label className="label-title col-sm-2">ATTENDENCE:</label>
                                <div className="input-group col-sm-10">
                                    <label for="male"><input type="radio" name="gender" value="present" id="male" onChange={(e) => props.setGender(e.target.value)} /> present</label>
                                    <label for="female"><input type="radio" name="gender" value="Absent" id="female" onChange={(e) => props.setGender(e.target.value)} /> Absent</label>
                                </div>
                            </div>
                            {/* row class */}
                            <div className="form-group row">
